...
# User inputs tsubscription package and how much data they used in a month
...
# If statements to determine which subscription package they have
...
# Total cost of subscription package.
